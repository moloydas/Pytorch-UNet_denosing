...
from utils.data_loading import DenoiserDataset, CarvanaDataset
...
def train_model(
    ...
    criterion = nn.L1Loss()##nn.MSELoss()#nn.CrossEntropyLoss() if model.n_classes > 1 else nn.BCEWithLogitsLoss()
    global_step = 0
